	soc_system u0 (
		...
		.led_patterns_avalon_led            (<connected-to-led_patterns_avalon_led>),            //     led_patterns_avalon.led
		.led_patterns_avalon_push_button    (<connected-to-led_patterns_avalon_push_button>),    //                        .push_button
		.led_patterns_avalon_switches       (<connected-to-led_patterns_avalon_switches>),       //                        .switches
		...
		.rgb_controller_avalon_rgb_output   (<connected-to-rgb_controller_avalon_rgb_output>),   //   rgb_controller_avalon.rgb_output
		.servo_controller_avalon_pwm_output (<connected-to-servo_controller_avalon_pwm_output>)  // servo_controller_avalon.pwm_output
	);
